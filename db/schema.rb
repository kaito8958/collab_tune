...
ActiveRecord::Schema[7.1].define(version: 2025_11_12_042910) do
  ...
  create_table "chat_rooms", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["collaboration_id"], name: "index_chat_rooms_on_collaboration_id"
  end
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.text "introduction"
    t.string "daw"
    t.json "performance_skills"
    t.json "production_skills"
    t.json "looking_for_skills"
    t.text "goal"
    t.json "links"
    t.json "genres"
  ...
  add_foreign_key "chat_rooms", "collaborations"
