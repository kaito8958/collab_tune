...
| 10 | チャット機能        | コラボ成立後の1対1チャット       | ChatRoom, Message            | ActionCableはローカル動作。本番は調整中／未読バッジあり         |
...
| ① 投稿一覧 & 音源プレビュー | ② 投稿詳細 & コラボ申請 |
| --- | --- |
| <img src="https://i.gyazo.com/fe02e9394167e1b31bdffe25f6709160.gif" width="320"><br>投稿がカード形式で一覧表示され、再生ボタンを押すだけでその場で音源を試聴できます。独自実装の AudioPlayer により、ページ遷移なしで楽曲の雰囲気をすぐに確認できる構成になっています。 | <img src="https://i.gyazo.com/dfc4188785d99c98dedd4cf6518f4c99.gif" width="320"><br>投稿詳細画面ではコメント投稿やメッセージ付きのコラボ申請が行えます。情報確認から申請までが１ページで完結する導線を意識し、迷わずやり取りが進められるUIにしています。 |

| ③ コラボ承認 → チャット自動生成 | ④ プロフィール編集 |
| --- | --- |
| <img src="https://i.gyazo.com/a9559acd3085037479b39818eb15c5dd.gif" width="320"><br>コラボ申請が承認されると、自動的に1対1のチャットルームが生成されます。未読バッジによる視認性も加わり、制作の連携や打ち合わせがスムーズに行える仕様です。 | <img src="https://i.gyazo.com/108d3c7c04b8556cd14cee1a6d786089.gif" width="320"><br>プロフィールでは DAW・得意スキル・募集スキル・ジャンル・SNSリンクなどを設定できます。これらをJSONで柔軟に管理し、ユーザーの方向性や強みが一目ですぐ伝わる構造となっています。 |
...
## 改善点
- 現在の検索・絞り込み機能は単語一致のみに対応しているため、  
  将来的には複数条件検索やタグベースのフィルタリングへ拡張したいです。

- チャット機能はローカルで動作確認済みですが、本番環境で安定稼働できていないため、  
  ActionCable の設定や WebSocket の接続方式を改善し、より堅牢にしたいと考えています。
